...
/*   Updated: 2023/03/20 14:53:28 by fsandel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Contact.hpp"

void	Contact::fillContact(std::string f_name, std::string l_name, std::string n_name, std::string p_number, std::string d_secret)
{
	first_name = f_name;
	last_name = l_name;
	nick_name = n_name;
...
void	Contact::showLine(const int index) const
{
	...
	std::cout << std::right << std::setw(10) << shortenString(this->nick_name) << std::endl;
}
