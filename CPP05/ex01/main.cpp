...
int	main(void)
{
	std::cout << "pass a38 with GradeToExec 151 and GradeToSign 75" << std::endl;
	try{
	...
	std::cout << "pass a38 with GradeToExec 0 and GradeToSign 75" << std::endl;
	try{
	...
	std::cout << "pass a38 with GradeToExec 75 and GradeToSign 151" << std::endl;
	try{
	...
	std::cout << "pass a38 with GradeToExec 57 and GradeToSign 0" << std::endl;
	try{
	...
	std::cout << "pass a38 with GradeToExec 50 and GradeToSign 100" << std::endl;
	try{
