...
/*   Updated: 2023/05/26 16:43:32 by fsandel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) : _Name(name) {
  std::cout << "Name Constructor got called on " << name << std::endl;
  this->_AttackDamage = 0;
  this->_EnergyPoints = 10;
  this->_HitPoints = 10;
}
...
ClapTrap::~ClapTrap() {
  std::cout << "Destructor got called on " << this->_Name << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount) {
  ...
  if (this->_EnergyPoints > 0) {
    ...
    std::cout << "ClapTrap " << this->_Name << " gets repaired for " << amount
              << " HP and now has " << this->_HitPoints << " HP left!"
              << std::endl;
    this->_EnergyPoints--;
  } else
    std::cout << "ClapTrap " << this->_Name
              << " doesnt have enough Energy to be Repaired!" << std::endl;
}
