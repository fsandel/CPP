...
/*   Updated: 2023/05/26 16:44:39 by fsandel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap::DiamondTrap(std::string name)
  ...
  this->_Name = name;
  std::cout << "Name DiamondTrap Constructor got called on " << this->_Name
            << std::endl;
}

DiamondTrap::~DiamondTrap() {
  std::cout << "DiamondTrap Destructor got called on " << this->_Name
            << std::endl;
}
