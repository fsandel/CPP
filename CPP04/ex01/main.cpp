...
/*   Updated: 2023/03/30 11:15:59 by fsandel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "comparing brain from both dogs to check for deep copy" << std::endl;
	...
	// std::cout << "comparing brain from both Cats to check for deep copy" << std::endl;
